...
class YtdlpGUI:
    def __init__(self, master):
        ...
        self.available_subtitles = []  # [(lang, type='normal'|'auto', display_lang)]
    ...
    def scan_subtitles(self):
        ...
        try:
            with YoutubeDL({'quiet': True, 'no_warnings': True}) as ydl:
                ...
                filtered_subs = []
                # 只保留 en, ja, ru, de, fr，以及简体中文(zh, zh-CN, zh-Hans)
                # 不要繁体，如 zh-Hant, zh-TW 等
                for (lang, t) in raw_subtitles:
                    # 简体中文条件：
                    # lang在['zh','zh-CN','zh-Hans']之一
                    # 或英语、日语、俄语、德语、法语
                ...
                if filtered_subs:
                    ...
                    self.log_output("未找到指定语言(仅简中/英/日/俄/德/法)的字幕。\n")
